import numpy as np 
import random
from RNNs import LSTMClassifier as Model
X_embedding_file = r'C:\Users\njq\Desktop\data\X_embedding_2and5_64.npy'
Y_vec_file = r'C:\Users\njq\Desktop\data\Y_vec_2and5_64.npy'
length_sentence_file=r'C:\Users\njq\Desktop\data\length_2and5_64.npy'
X_embedding_file_test = r'C:\Users\njq\Desktop\data\X_embedding_2and5_64.npy'
#this should be changed to a new data set when applying actually
#I split the data set for train and test instead.
Y_vec_file_test = r'C:\Users\njq\Desktop\data\Y_vec_2and5_64.npy'
length_sentence_file_test=r'C:\Users\njq\Desktop\data\length_2and5_64.npy'
...
def test():
    ...
    # prediction >= n_split means that there are at least n_split models predict the output as 1
    prediction_final=np.where(prediction>=n_split,1,0)
